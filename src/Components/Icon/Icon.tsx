...
export const Icon: React.FC<IconProps> = ({
  ...
  return isButton ? (
    <button className='relative z-0 flex items-center w-full h-full text-gray-400 transition duration-150 ease-in-out focus:outline-none focus:text-gray-500 hover:text-gray-500'>
      {iconElement}
    </button>
  ) : (
    iconElement
